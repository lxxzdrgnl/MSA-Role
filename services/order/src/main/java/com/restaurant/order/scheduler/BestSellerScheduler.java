package com.restaurant.order.scheduler;
...
public class BestSellerScheduler {
    ...
    public void updateBestSellers() {
        log.info("Starting best seller update scheduler");
        try {
            ...
            for (BestSellerResponse seller : topSellers) {
                try {
                    ...
                    log.info("Updated best seller flag for menu {}: {}", seller.getMenuId(), seller.getMenuName());
                } catch (Exception e) {
